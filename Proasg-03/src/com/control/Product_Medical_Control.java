...
@MultipartConfig
public class Product_Medical_Control extends HttpServlet {
    
	private static final long serialVersionUID = 1L;
	
    A_Medical_Dao MedicDao = new A_Medical_Dao();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Insert database.
            ...
            MedicDao.addMedicalProduct(name, cost, photo);
