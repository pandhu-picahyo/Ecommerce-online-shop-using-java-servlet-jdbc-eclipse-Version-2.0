...
import com.dao.A_Electrical_Dao;
...
@MultipartConfig
public class Product_Electronic_Control extends HttpServlet {
    
	private static final long serialVersionUID = 1L;
	
    A_Electrical_Dao ElecDao = new A_Electrical_Dao();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Insert database.
            ...
            ElecDao.addElectronicProduct(name, cost, photo);
