...
<%@page import="com.info.A_Electronic"%>
<%@page import="com.dao.A_Electrical_Dao"%>
<%
...
<%@ include file = "header.html" %>
	...
	<form method="get" action="./electronicorder">
	...
	<%
		try{
			...
			String sql ="select * from productelectronic";
			resultSet = statement.executeQuery(sql);

		while(resultSet.next()){
	%>
	<div class="grid-item">
		<img src="Image_Electronic?id=<%=resultSet.getInt("id") %>" width= "50px" />
